/** Arduino Pro Mini                                     *** Walk_Defines.h ***
 * 
 * Определения (наборы мелодий) библиотеки звуковых вставок в приложение 
 * 
 * v1.0, 22.08.2024                                   Автор:      Труфанов В.Е.
 * Copyright © 2024 tve                               Дата создания: 22.08.2024
**/
...
{
  // Фрагмент Fur Elise - Ludwig van Beethovem
...
int lovim_dvizhenie[] = 
{
  // Фрагмент Dart Vader theme (Imperial March) - Star wars 
