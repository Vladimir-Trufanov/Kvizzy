...
- ***vPrint***, выборка из очереди и вывод сообщений в последовательный порт  (с интервалом 439 мсек) . Приоритет 9.
...
- ***queMessa***, очередь сообщений в последовательный порт и на периферию;
