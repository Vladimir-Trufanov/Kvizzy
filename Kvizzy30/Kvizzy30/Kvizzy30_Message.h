...
tmessAPP amessAPP[] = 
{
    ...
    {http404,      tvm_simpmes, "Не найдено, запрашиваемая страница не найдена на сервере"},
    {http405,      tvm_simpmes, "Метод не допускается, указанный в запросе метод не допускается для заданного ресурса"},
