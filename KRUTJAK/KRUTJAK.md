...
### Таймеры, моторы и распиновка Arduino Pro Mini

```
Timer0 -  8 бит, счетный регистр   [0,255], используется delay(), millis()
Timer1 - 16 бит, счетный регистр [0,65535], используется драйвером мотора
     (здесь используется в управляющей системе "КРУТЯК")
Timer2 -  8 бит, счетный регистр   [0,255], используется tone() 
     (здесь используется в исполнительной системе "КРУТЯК")

Малый мотор:  V = 4.71В,    A =  45 mA => 105 Oм
Мотор Крутяк: V = 3.9В,     A = 300 mA =>  13 Oм
```

![](raspinovka-arduino-pro-mini.jpg)


### Как загрузить программу КРУТЯК-мастер через USBASP:

а) через меню ***Файл -> Загрузить через программатор***;

б) используя сочетание клавиш ***Ctrl + Shift + U***;

в) зажав клавишу ***Shift, нажать на кнопку со стрелкой вправо***, которая обычно используется для загрузки скетча в память Ардуино стандартным способом.

![Подключение программатора КРУТЯК-мастер](podklyuchenie-programmatora-krutyak-master.png)

### Подключение OLED-дисплея:

```                               
 A5 - красный - желтый - SCL
 A4 - черный  - синий  - SDA
 ```
![Подключение OLED-дисплея](podklyuchenie-OLED.png)

### Подключение мотора:

![Подключение мотора с питанием от платы Arduino](podklyuchenie-motora-s-platy.png)

```
DIR_PIN = "D"      6        // направление движения мотора 6 (белый)
PWM_PIN = "S"      7        // ШИМ-сигнал на мотор (0-255) 7 (синий)
 ```

![Подключение драйвера](podklyuchenie-draivera.png)
...
### [3. Прo ШИМ](#%D0%BF%D1%80%D0%BE-%D1%88%D0%B8%D0%BC)

### [4. Прo полевой транзистор IRFZ24N](#%D0%BF%D1%80%D0%BE-%D0%BF%D0%BE%D0%BB%D0%B5%D0%B2%D0%BE%D0%B9-%D1%82%D1%80%D0%B0%D0%BD%D0%B7%D0%B8%D1%81%D1%82%D0%BE%D1%80-irfz24n)

### [5. Прo полевой транзистор IRF9Z24N](#%D0%BF%D1%80%D0%BE-%D0%BF%D0%BE%D0%BB%D0%B5%D0%B2%D0%BE%D0%B9-%D1%82%D1%80%D0%B0%D0%BD%D0%B7%D0%B8%D1%81%D1%82%D0%BE%D1%80-irf9z24n)

### [6. Драйвер мoтора - управление скоростью и направлением от потенциометра](#%D0%B4%D1%80%D0%B0%D0%B9%D0%B2%D0%B5%D1%80-%D0%BC%D0%BE%D1%82%D0%BE%D1%80%D0%B0---%D1%83%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5-%D1%81%D0%BA%D0%BE%D1%80%D0%BE%D1%81%D1%82%D1%8C%D1%8E-%D0%B8-%D0%BD%D0%B0%D0%BF%D1%80%D0%B0%D0%B2%D0%BB%D0%B5%D0%BD%D0%B8%D0%B5%D0%BC-%D0%BE%D1%82-%D0%BF%D0%BE%D1%82%D0%B5%D0%BD%D1%86%D0%B8%D0%BE%D0%BC%D0%B5%D1%82%D1%80%D0%B0)

### [7. Трассировка сигналoв от потенциометра и на двигатель](#%D1%82%D1%80%D0%B0%D1%81%D1%81%D0%B8%D1%80%D0%BE%D0%B2%D0%BA%D0%B0-%D1%81%D0%B8%D0%B3%D0%BD%D0%B0%D0%BB%D0%BE%D0%B2-%D0%BE%D1%82-%D0%BF%D0%BE%D1%82%D0%B5%D0%BD%D1%86%D0%B8%D0%BE%D0%BC%D0%B5%D1%82%D1%80%D0%B0-%D0%B8-%D0%BD%D0%B0-%D0%B4%D0%B2%D0%B8%D0%B3%D0%B0%D1%82%D0%B5%D0%BB%D1%8C)
...
###### [в начало](#%D1%85%D1%80%D0%BE%D0%BDo%D0%BB%D0%BE%D0%B3%D0%B8%D1%8F-%D1%81%D0%BE%D0%B1%D1%8B%D1%82%D0%B8%D0%B9)
...
Малый мотор:  V=4.71В, A=45 mA => 105 Oм
Мотор Крутяк: V=3.9В,  A=300mA =>  13 Oм
```

![](MotorOtPotenciometra.jpg) 
...
### [Скетч модели администратора мотора](instrument-infrakrasnogo-upravleniya/instrument-infrakrasnogo-upravleniya.ino)
