...
String currCmd="x";               // принятая команда
String oldiCmd="x";               // прежняя команда

// Контрольные значения ШИМ
#define MAX_SPEED      255        // максимум
#define START_SPEED    134 //101        // стартовая скорость
#define MIN_SPEED      128 // 64        // минимум 
