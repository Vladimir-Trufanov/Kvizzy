/** KRUTJAK-MASTER-PRO_MINI ****************************** *** mk03-Timer.ino ***
 * 
...
ISR(TIMER1_COMPA_vect)
{
   ...
   myOLED.print(F("Vsm"),0,7);                  // Выводим текст начиная с  0 столбца 7 строки (высота шрифта 2 строки, он займёт строки 6 и 7).
   myOLED.print(analogRead_VCC(),40,7);                  // Выводим текст начиная с  0 столбца 7 строки (высота шрифта 2 строки, он займёт строки 6 и 7).
   myOLED.print(F("4.91"),80,7);                  // Выводим текст начиная с  0 столбца 7 строки (высота шрифта 2 строки, он займёт строки 6 и 7)   // 
}
