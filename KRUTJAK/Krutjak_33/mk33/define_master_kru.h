...
// Переменные для отсчета времени движения
uint32_t bSec;                    // общие секунды на начало движения
uint32_t bTick;                   // время в секундах с начала движения
int timeMins;                     // минуты
int timeSecs;                     // секунды
String sMins = "00";              // выводимое время в минутах с начала движения
String sSecs = "00";              // выводимое время в секундах с начала движения
bool isMove = false;              // признак начала движения

String ystrData="";               // принимаемая последовательность сообщения
char ysimb;                       // очередной принятый символ
String viewData="";               // принятое сообщение                  
